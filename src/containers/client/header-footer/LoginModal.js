...
class LoginModal extends Component {
    ...
    handleSignUp = async () => {
        ...
        if (username && password) {
            let res = await this.props.getLoginIntoSystem(username, password)
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        getLoginIntoSystem: (username, password) => dispatch(Action.getLoginIntoSystemAction(username, password)),
